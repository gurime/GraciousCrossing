...
const querySnapshot = await getDocs(collection(db, "Africa"));
const data = [];
...
export default function AfricaListings() {
...
const commentsRef = collection(db, 'Africa');
...
const db = getFirestore();
const commentDoc = await getDoc(doc(db, 'Africa', postId));
if (commentDoc.exists()) {
await deleteDoc(doc(db, 'Africa', postId));
...
<div className='AfricaHero'>
<div>
<h1>Explore Africa's Homes, Apartments, Motels, & Hotels</h1>
