...
const querySnapshot = await getDocs(collection(db, "Vacation Rentals"));
const data = [];
...
export default function VacationListing() {
    ...
    const commentsRef = collection(db, 'Vacation Rentals');
    ...
    const db = getFirestore();
    const commentDoc = await getDoc(doc(db, 'Vacation Rentals', postId));
    if (commentDoc.exists()) {
    await deleteDoc(doc(db, 'Vacation Rentals', postId));
    ...
    <div className='VacationArticleHero'>
    <div>
