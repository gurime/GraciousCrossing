...
const querySnapshot = await getDocs(collection(db, "Caribbean"));
const data = [];
...
export default function CaribbeanListings() {
...
const commentsRef = collection(db, 'Caribbean');
...
const db = getFirestore();
const commentDoc = await getDoc(doc(db, 'Caribbean', postId));
if (commentDoc.exists()) {
await deleteDoc(doc(db, 'Caribbean', postId));
