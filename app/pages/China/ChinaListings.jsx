...
const querySnapshot = await getDocs(collection(db, "China"));
const data = [];
...
export default function ChinaListings() {
...
const commentsRef = collection(db, 'China');
...
const db = getFirestore();
const commentDoc = await getDoc(doc(db, 'China', postId));
if (commentDoc.exists()) {
await deleteDoc(doc(db, 'China', postId));
...
<div className='ChinaHero'>
<div>
  <h1>Explore China's Homes, Apartments, Motels, & Hotels</h1>
