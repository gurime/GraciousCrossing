...
const querySnapshot = await getDocs(collection(db, "Greenland"));
const data = [];
...
export default function GreenlandListings() {
...
const commentsRef = collection(db, 'Greenland');
...
const db = getFirestore();
const commentDoc = await getDoc(doc(db, 'Greenland', postId));
if (commentDoc.exists()) {
await deleteDoc(doc(db, 'Greenland', postId));
...
<div className='GreenlandHero'>
<div>
  <h1>Explore Greenland's Homes, Apartments, Motels, & Hotels</h1>
