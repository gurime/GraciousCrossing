...
export default function HotelListings() {
    ...
    const commentsRef = collection(db, 'Hotel');
    ...
    const db = getFirestore();
    const commentDoc = await getDoc(doc(db, 'Hotel', postId));
    if (commentDoc.exists()) {
    await deleteDoc(doc(db, 'Hotel', postId));
    ...
    <div className='HotelArticleHero'>
    <div>
      <h1>Hotel For Rent</h1>
