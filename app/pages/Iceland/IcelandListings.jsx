...
const querySnapshot = await getDocs(collection(db, "Iceland"));
const data = [];
...
export default function IcelandListings() {
...
const commentsRef = collection(db, 'Iceland');
...
const db = getFirestore();
const commentDoc = await getDoc(doc(db, 'Iceland', postId));
if (commentDoc.exists()) {
await deleteDoc(doc(db, 'Iceland', postId));
...
<div className='IcelandHero'>
<div>
  <h1>Explore Iceland's Homes, Apartments, Motels, & Hotels</h1>
