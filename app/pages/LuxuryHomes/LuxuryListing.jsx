...
const querySnapshot = await getDocs(collection(db, "Luxury Homes"));
const data = [];
...
export default function LuxuryLisiting() {
    ...
    const commentsRef = collection(db, 'Luxury Homes');
    ...
    const db = getFirestore();
    const commentDoc = await getDoc(doc(db, 'Luxury Homes', postId));
    if (commentDoc.exists()) {
    await deleteDoc(doc(db, 'Luxury Homes', postId));
