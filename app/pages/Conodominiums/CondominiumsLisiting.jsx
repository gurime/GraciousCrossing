...
export default function Condominiums() {
    ...
    const commentsRef = collection(db, 'Condominiums');
    ...
    const db = getFirestore();
    const commentDoc = await getDoc(doc(db, 'Condominiums', postId));
    if (commentDoc.exists()) {
    await deleteDoc(doc(db, 'Condominiums', postId));
    ...
    <div className='CondominiumsHero'>
    <div>
      <h1>Condominiums</h1>
