...
const querySnapshot = await getDocs(collection(db, "Senior Housing"));
const data = [];
...
export default function SeniorListings() {
    ...
    const commentsRef = collection(db, 'Senior Housing');
    ...
    const db = getFirestore();
    const commentDoc = await getDoc(doc(db, 'Senior Housing', postId));
    if (commentDoc.exists()) {
    await deleteDoc(doc(db, 'Senior Housing', postId));
