...
const querySnapshot = await getDocs(collection(db, "Canada"));
const data = [];
...
export default function CanadaListings() {
...
const commentsRef = collection(db, 'Canada');
...
const db = getFirestore();
const commentDoc = await getDoc(doc(db, 'Canada', postId));
if (commentDoc.exists()) {
await deleteDoc(doc(db, 'Canada', postId));
